    ...
    fields: [
      {
        ...
        type: "select",
        help: "How clusters are discovered. 'pc' queries Prism Central; 'list' uses the manual list; 'file' reads from a file.",
        options: [
          { value: "pc", label: "Prism Central (recommended)" },
          { value: "list", label: "Manual list" },
          { value: "file", label: "Cluster file" },
        ],
      },
      {
        key: "pcs",
