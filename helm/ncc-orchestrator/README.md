...
Renders the **CronJob** that runs `ncc-orchestrator` on a schedule. You still need **ConfigMap**, **Secret** (password), **PVC**, and **namespace** from the main `k8s/` manifests or your own.
