...
2. **Docker image**: The CronJob uses `prajwalnutant/nutanix-ncc-orchestrator:0.1.12` from Docker Hub. To use another tag or a private image, edit the `image` field in `cronjob.yaml`.
